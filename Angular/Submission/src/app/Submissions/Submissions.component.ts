...
export class SubmissionsComponent implements OnInit {
  ...
  items = [
    { id:1,full_name: 'Swathi', lead_name: 'Kranthi', technology: 'Java',vendor_name:'Tech Systems',rate:'75/hr'},
    { id:2,full_name: 'Prathyusha', lead_name: 'Tejan', technology: 'Java',vendor_name:'Judge group',rate:'73/hr'},
    { id:3,full_name: 'Rachana', lead_name: 'Jagadeesh', technology: 'Devops',vendor_name:'Avtech Solutions',rate:'75/hr' },
    { id:4,full_name: 'Tejaswi', lead_name: 'Kranthi', technology: 'Java',vendor_name:'Prodware solutions',rate:'70/hr' },
    { id:5,full_name: 'Niharika', lead_name: 'Manohar', technology: 'Devops',vendor_name:'Tech Systems',rate:'69/hr' },
    { id:6,full_name: 'Naveen', lead_name: 'Spandana', technology: 'Salesforce',vendor_name:'Diamond Pick',rate:'65/hr' },
